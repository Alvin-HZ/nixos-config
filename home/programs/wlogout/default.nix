...
#lock {
    background-image: image(url("/nix/store/n2znc0cjx6wxd4xwp246pp7g469zyim3-wlogout-1.2.2/share/wlogout/icons/lock.png"), url("/usr/local/share/wlogout/icons/lock.png"));
}
...
#hibernate {
    background-image: image(url("/nix/store/n2znc0cjx6wxd4xwp246pp7g469zyim3-wlogout-1.2.2/share/wlogout/icons/hibernate.png"), url("/usr/local/share/wlogout/icons/hibernate.png"));
}
